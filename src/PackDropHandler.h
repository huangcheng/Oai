...
/**
 * Drag-and-drop install handling for .spk and .codex-pet archives.
 *
...
/// Returns true if `filePath` is a .spk OR a .codex-pet whose pet.json
...
/// Process a drop event. Walks the URL list, installs .spk files via
